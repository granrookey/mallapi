package org.glocol.mallapi.repository;

import java.util.List;

import org.glocol.mallapi.domain.Cart;
import org.glocol.mallapi.domain.CartItem;
...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
        ...
        @Query("select " +
                        " new org.glocol.mallapi.dto.CartItemListDTO(ci.cino,  ci.qty,  p.pno, p.pname, p.price , pi.fileName )  "
                        +
                        " from " +
        ...
        @Query("select new org.glocol.mallapi.dto.CartItemListDTO(ci.cino,  ci.qty,  p.pno, p.pname, p.price , pi.fileName )  "
                        +
                        " from " +
                        "   CartItem ci inner join Cart mc on ci.cart = mc " +
                        "   left join Product p on ci.product = p " +
